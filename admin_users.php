...
function generatePDF($conn)
{
   ...
   while ($fetch_users = $select_users->fetch(PDO::FETCH_ASSOC)) {
      $pdf->Cell(40, 10, $fetch_users['id'], 1);
      $pdf->Cell(60, 10, $fetch_users['name'], 1);
      $pdf->Cell(60, 10, $fetch_users['email'], 1);
      $pdf->Cell(40, 10, $fetch_users['user_type'], 1);
      $pdf->Ln();
   }

   $pdf->Output('user_accounts.pdf', 'D');
